...
function Body() {
    return (_jsxs("div", { className: "p-6 bg-gray-50 min-h-screen", children: [_jsx("h1", { className: "text-3xl font-bold text-center mb-8 text-gray-800", children: "Human Muscle Groups" }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: muscleGroups.map((muscle, idx) => (_jsxs("div", { className: "bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-200", children: [_jsx("h2", { className: "text-xl font-semibold text-blue-600 mb-3", children: muscle.title }), _jsx("img", { src: muscle.image, alt: muscle.title, className: "w-full h-auto object-contain rounded-lg mb-4" }), _jsx("p", { className: "text-gray-700 leading-relaxed whitespace-pre-line", children: muscle.description })] }, idx))) })] }));
}
export default Body;
